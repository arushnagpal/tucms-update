        ...
        <div id="type">
            <center>
                ...
                if (!isset($_SESSION['error']) || (isset($_SESSION['error']) && $_SESSION['error'] != 'SUCCESS')) {
                    ...
                    ?>
                    <form action="<?php echo base_url(); ?>complaint/checkEmail" method="post">
                ...
                <ul class="actions" style="text-align:center">
                    <li><a href="<?php echo base_url(); ?>complaint" class="special">Click here </a> to go back</li>
                    <li><a href="<?php echo base_url(); ?>complaint/sign_in" class="special">Click here </a> to login</li>
                </ul>
            </center>
        </div>
    </div>
